...
class ItemType(str, Enum):
    DIRECTORY = "directory" # Also a 'drive'
    RAW_FILE = "raw_file"
...
# This is the permission for an item as defined for the current Client user
@dataclass
...
# This is the base class for all items in a directory
class DriveItem:
